...
encode_typed_field(account, V) -> V;
encode_typed_field(adv_id, V) -> V;
encode_typed_field(adv_ref_id, V) -> V;
encode_typed_field(adv_side, V) -> V;
encode_typed_field(adv_trans_type, V) -> V;
encode_typed_field(avg_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(begin_seq_no, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(begin_string, V) -> V;
encode_typed_field(body_length, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(check_sum, V) -> V;
encode_typed_field(cl_ord_id, V) -> V;
encode_typed_field(commission, V) -> V;
encode_typed_field(comm_type, V) -> V;
encode_typed_field(cum_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(currency, V) -> V;
encode_typed_field(end_seq_no, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(exec_id, V) -> V;
encode_typed_field(exec_inst, V) -> V;
encode_typed_field(exec_ref_id, V) -> V;
encode_typed_field(exec_trans_type, V) -> V;
encode_typed_field(handl_inst, V) -> V;
encode_typed_field(security_id_source, V) -> V;
encode_typed_field(ioi_id, V) -> V;
encode_typed_field(ioi_oth_svc, V) -> V;
encode_typed_field(ioi_qlty_ind, V) -> V;
encode_typed_field(ioi_ref_id, V) -> V;
encode_typed_field(ioi_qty, V) -> V;
encode_typed_field(ioi_trans_type, V) -> V;
encode_typed_field(last_capacity, V) -> V;
encode_typed_field(last_mkt, V) -> V;
encode_typed_field(last_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(last_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_lines_of_text, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(msg_seq_num, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(msg_type, V) -> number_by_message(V);
encode_typed_field(new_seq_no, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(order_id, V) -> V;
encode_typed_field(order_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(ord_status, V) -> V;
encode_typed_field(ord_type, V) -> V;
encode_typed_field(orig_cl_ord_id, V) -> V;
encode_typed_field(orig_time, V) -> V;
encode_typed_field(poss_dup_flag, true) -> <<"Y">>;
encode_typed_field(poss_dup_flag,false) -> <<"N">>;
encode_typed_field(price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(ref_seq_num, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(relatd_sym, V) -> V;
encode_typed_field(rule80a, V) -> V;
encode_typed_field(security_id, V) -> V;
encode_typed_field(sender_comp_id, V) -> V;
encode_typed_field(sender_sub_id, V) -> V;
encode_typed_field(sending_date, V) -> V;
encode_typed_field(sending_time, V) -> V;
encode_typed_field(quantity, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(side, V) -> V;
encode_typed_field(symbol, V) -> V;
encode_typed_field(target_comp_id, V) -> V;
encode_typed_field(target_sub_id, V) -> V;
encode_typed_field(text, V) -> V;
encode_typed_field(time_in_force, V) -> V;
encode_typed_field(transact_time, V) -> V;
encode_typed_field(urgency, V) -> V;
encode_typed_field(valid_until_time, V) -> V;
encode_typed_field(settl_type, V) -> V;
encode_typed_field(settl_date, V) -> V;
encode_typed_field(symbol_sfx, V) -> V;
encode_typed_field(list_id, V) -> V;
encode_typed_field(list_seq_no, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(tot_no_orders, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(list_exec_inst, V) -> V;
encode_typed_field(alloc_id, V) -> V;
encode_typed_field(alloc_trans_type, V) -> V;
encode_typed_field(ref_alloc_id, V) -> V;
encode_typed_field(no_orders, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(avg_px_precision, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trade_date, V) -> V;
encode_typed_field(exec_broker, V) -> V;
encode_typed_field(position_effect, V) -> V;
encode_typed_field(no_allocs, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(alloc_account, V) -> V;
encode_typed_field(alloc_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(process_code, V) -> V;
encode_typed_field(no_rpts, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(rpt_seq, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(cxl_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_dlvy_inst, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(dlvy_inst, V) -> V;
encode_typed_field(alloc_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(alloc_rej_code, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(signature, V) -> V;
encode_typed_field(secure_data_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(secure_data, V) -> V;
encode_typed_field(broker_of_credit, V) -> V;
encode_typed_field(signature_length, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(email_type, V) -> V;
encode_typed_field(raw_data_length, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(raw_data, V) -> V;
encode_typed_field(poss_resend, true) -> <<"Y">>;
encode_typed_field(poss_resend,false) -> <<"N">>;
encode_typed_field(encrypt_method, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(stop_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(ex_destination, V) -> V;
encode_typed_field(cxl_rej_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(ord_rej_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(ioi_qualifier, V) -> V;
encode_typed_field(wave_no, V) -> V;
encode_typed_field(issuer, V) -> V;
encode_typed_field(security_desc, V) -> V;
encode_typed_field(heart_bt_int, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(client_id, V) -> V;
encode_typed_field(min_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(max_floor, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(test_req_id, V) -> V;
...
encode_typed_field(on_behalf_of_comp_id, V) -> V;
encode_typed_field(on_behalf_of_sub_id, V) -> V;
encode_typed_field(quote_id, V) -> V;
encode_typed_field(net_money, V) -> V;
encode_typed_field(settl_curr_amt, V) -> V;
encode_typed_field(settl_currency, V) -> V;
encode_typed_field(forex_req, true) -> <<"Y">>;
encode_typed_field(forex_req,false) -> <<"N">>;
encode_typed_field(orig_sending_time, V) -> V;
encode_typed_field(gap_fill_flag, true) -> <<"Y">>;
encode_typed_field(gap_fill_flag,false) -> <<"N">>;
encode_typed_field(no_execs, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(cxl_type, V) -> V;
encode_typed_field(expire_time, V) -> V;
encode_typed_field(dk_reason, V) -> V;
encode_typed_field(deliver_to_comp_id, V) -> V;
encode_typed_field(deliver_to_sub_id, V) -> V;
encode_typed_field(ioi_natural_flag, true) -> <<"Y">>;
encode_typed_field(ioi_natural_flag,false) -> <<"N">>;
encode_typed_field(quote_req_id, V) -> V;
encode_typed_field(bid_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(offer_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(bid_size, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(offer_size, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_misc_fees, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(misc_fee_amt, V) -> V;
encode_typed_field(misc_fee_curr, V) -> V;
encode_typed_field(misc_fee_type, V) -> V;
encode_typed_field(prev_close_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(reset_seq_num_flag, true) -> <<"Y">>;
encode_typed_field(reset_seq_num_flag,false) -> <<"N">>;
encode_typed_field(sender_location_id, V) -> V;
encode_typed_field(target_location_id, V) -> V;
encode_typed_field(on_behalf_of_location_id, V) -> V;
encode_typed_field(deliver_to_location_id, V) -> V;
encode_typed_field(no_related_sym, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(subject, V) -> V;
encode_typed_field(headline, V) -> V;
encode_typed_field(url_link, V) -> V;
encode_typed_field(exec_type, V) -> V;
encode_typed_field(leaves_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(cash_order_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(alloc_avg_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(alloc_net_money, V) -> V;
encode_typed_field(settl_curr_fx_rate, V) -> V;
encode_typed_field(settl_curr_fx_rate_calc, V) -> V;
encode_typed_field(num_days_interest, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(accrued_interest_rate, V) -> V;
encode_typed_field(accrued_interest_amt, V) -> V;
encode_typed_field(settl_inst_mode, V) -> V;
encode_typed_field(alloc_text, V) -> V;
encode_typed_field(settl_inst_id, V) -> V;
encode_typed_field(settl_inst_trans_type, V) -> V;
encode_typed_field(email_thread_id, V) -> V;
encode_typed_field(settl_inst_source, V) -> V;
encode_typed_field(settl_location, V) -> V;
encode_typed_field(security_type, V) -> V;
encode_typed_field(effective_time, V) -> V;
encode_typed_field(stand_inst_db_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(stand_inst_db_name, V) -> V;
encode_typed_field(stand_inst_db_id, V) -> V;
encode_typed_field(settl_delivery_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(settl_depository_code, V) -> V;
encode_typed_field(settl_brkr_code, V) -> V;
encode_typed_field(settl_inst_code, V) -> V;
encode_typed_field(security_settl_agent_name, V) -> V;
encode_typed_field(security_settl_agent_code, V) -> V;
encode_typed_field(security_settl_agent_acct_num, V) -> V;
encode_typed_field(security_settl_agent_acct_name, V) -> V;
encode_typed_field(security_settl_agent_contact_name, V) -> V;
encode_typed_field(security_settl_agent_contact_phone, V) -> V;
encode_typed_field(cash_settl_agent_name, V) -> V;
encode_typed_field(cash_settl_agent_code, V) -> V;
encode_typed_field(cash_settl_agent_acct_num, V) -> V;
encode_typed_field(cash_settl_agent_acct_name, V) -> V;
encode_typed_field(cash_settl_agent_contact_name, V) -> V;
encode_typed_field(cash_settl_agent_contact_phone, V) -> V;
encode_typed_field(bid_spot_rate, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(bid_forward_points, V) -> V;
encode_typed_field(offer_spot_rate, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(offer_forward_points, V) -> V;
encode_typed_field(order_qty2, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(settl_date2, V) -> V;
encode_typed_field(last_spot_rate, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(last_forward_points, V) -> V;
encode_typed_field(alloc_link_id, V) -> V;
encode_typed_field(alloc_link_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(secondary_order_id, V) -> V;
encode_typed_field(no_ioi_qualifiers, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(maturity_month_year, V) -> V;
encode_typed_field(put_or_call, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(strike_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(covered_or_uncovered, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(customer_or_firm, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(maturity_day, V) -> V;
encode_typed_field(opt_attribute, V) -> V;
encode_typed_field(security_exchange, V) -> V;
encode_typed_field(notify_broker_of_credit, true) -> <<"Y">>;
encode_typed_field(notify_broker_of_credit,false) -> <<"N">>;
encode_typed_field(alloc_handl_inst, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(max_show, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(peg_offset_value, V) -> V;
encode_typed_field(xml_data_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(xml_data, V) -> V;
encode_typed_field(settl_inst_ref_id, V) -> V;
encode_typed_field(no_routing_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(routing_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(routing_id, V) -> V;
encode_typed_field(spread, V) -> V;
encode_typed_field(benchmark, V) -> V;
encode_typed_field(benchmark_curve_currency, V) -> V;
encode_typed_field(benchmark_curve_name, V) -> V;
encode_typed_field(benchmark_curve_point, V) -> V;
encode_typed_field(coupon_rate, V) -> V;
encode_typed_field(coupon_payment_date, V) -> V;
encode_typed_field(issue_date, V) -> V;
encode_typed_field(repurchase_term, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(repurchase_rate, V) -> V;
encode_typed_field(factor, V) -> V;
encode_typed_field(trade_origination_date, V) -> V;
encode_typed_field(ex_date, V) -> V;
encode_typed_field(contract_multiplier, V) -> V;
encode_typed_field(no_stipulations, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(stipulation_type, V) -> V;
encode_typed_field(stipulation_value, V) -> V;
encode_typed_field(yield_type, V) -> V;
encode_typed_field(yield, V) -> V;
encode_typed_field(total_takedown, V) -> V;
encode_typed_field(concession, V) -> V;
encode_typed_field(repo_collateral_security_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(redemption_date, V) -> V;
encode_typed_field(underlying_coupon_payment_date, V) -> V;
encode_typed_field(underlying_issue_date, V) -> V;
encode_typed_field(underlying_repo_collateral_security_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(underlying_repurchase_term, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(underlying_repurchase_rate, V) -> V;
encode_typed_field(underlying_factor, V) -> V;
encode_typed_field(underlying_redemption_date, V) -> V;
encode_typed_field(leg_coupon_payment_date, V) -> V;
encode_typed_field(leg_issue_date, V) -> V;
encode_typed_field(leg_repo_collateral_security_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_repurchase_term, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_repurchase_rate, V) -> V;
encode_typed_field(leg_factor, V) -> V;
encode_typed_field(leg_redemption_date, V) -> V;
encode_typed_field(credit_rating, V) -> V;
encode_typed_field(underlying_credit_rating, V) -> V;
encode_typed_field(leg_credit_rating, V) -> V;
encode_typed_field(traded_flat_switch, true) -> <<"Y">>;
encode_typed_field(traded_flat_switch,false) -> <<"N">>;
encode_typed_field(basis_feature_date, V) -> V;
encode_typed_field(basis_feature_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(md_req_id, V) -> V;
encode_typed_field(subscription_request_type, V) -> V;
encode_typed_field(market_depth, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(md_update_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(aggregated_book, true) -> <<"Y">>;
encode_typed_field(aggregated_book,false) -> <<"N">>;
encode_typed_field(no_md_entry_types, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_md_entries, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(md_entry_type, V) -> V;
encode_typed_field(md_entry_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(md_entry_size, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(md_entry_date, V) -> V;
encode_typed_field(md_entry_time, V) -> V;
encode_typed_field(tick_direction, V) -> V;
encode_typed_field(md_mkt, V) -> V;
encode_typed_field(quote_condition, V) -> V;
encode_typed_field(trade_condition, V) -> V;
encode_typed_field(md_entry_id, V) -> V;
encode_typed_field(md_update_action, V) -> V;
encode_typed_field(md_entry_ref_id, V) -> V;
encode_typed_field(md_req_rej_reason, V) -> V;
encode_typed_field(md_entry_originator, V) -> V;
encode_typed_field(location_id, V) -> V;
encode_typed_field(desk_id, V) -> V;
encode_typed_field(delete_reason, V) -> V;
encode_typed_field(open_close_settl_flag, V) -> V;
encode_typed_field(seller_days, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(md_entry_buyer, V) -> V;
encode_typed_field(md_entry_seller, V) -> V;
encode_typed_field(md_entry_position_no, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(financial_status, V) -> V;
encode_typed_field(corporate_action, V) -> V;
encode_typed_field(def_bid_size, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(def_offer_size, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_quote_entries, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_quote_sets, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(quote_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(quote_cancel_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(quote_entry_id, V) -> V;
encode_typed_field(quote_reject_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(quote_response_level, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(quote_set_id, V) -> V;
encode_typed_field(quote_request_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(tot_no_quote_entries, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(underlying_security_id_source, V) -> V;
encode_typed_field(underlying_issuer, V) -> V;
encode_typed_field(underlying_security_desc, V) -> V;
encode_typed_field(underlying_security_exchange, V) -> V;
encode_typed_field(underlying_security_id, V) -> V;
encode_typed_field(underlying_security_type, V) -> V;
encode_typed_field(underlying_symbol, V) -> V;
encode_typed_field(underlying_symbol_sfx, V) -> V;
encode_typed_field(underlying_maturity_month_year, V) -> V;
encode_typed_field(underlying_maturity_day, V) -> V;
encode_typed_field(underlying_put_or_call, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(underlying_strike_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(underlying_opt_attribute, V) -> V;
encode_typed_field(underlying_currency, V) -> V;
encode_typed_field(ratio_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(security_req_id, V) -> V;
encode_typed_field(security_request_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(security_response_id, V) -> V;
encode_typed_field(security_response_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(security_status_req_id, V) -> V;
encode_typed_field(unsolicited_indicator, true) -> <<"Y">>;
encode_typed_field(unsolicited_indicator,false) -> <<"N">>;
encode_typed_field(security_trading_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(halt_reason_char, V) -> V;
...
encode_typed_field(buy_volume, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(sell_volume, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(high_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(low_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(adjustment, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trad_ses_req_id, V) -> V;
encode_typed_field(trading_session_id, V) -> V;
encode_typed_field(contra_trader, V) -> V;
encode_typed_field(trad_ses_method, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trad_ses_mode, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trad_ses_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trad_ses_start_time, V) -> V;
encode_typed_field(trad_ses_open_time, V) -> V;
encode_typed_field(trad_ses_pre_close_time, V) -> V;
encode_typed_field(trad_ses_close_time, V) -> V;
encode_typed_field(trad_ses_end_time, V) -> V;
encode_typed_field(number_of_orders, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(message_encoding, V) -> V;
encode_typed_field(encoded_issuer_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_issuer, V) -> V;
encode_typed_field(encoded_security_desc_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_security_desc, V) -> V;
encode_typed_field(encoded_list_exec_inst_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_list_exec_inst, V) -> V;
encode_typed_field(encoded_text_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_text, V) -> V;
encode_typed_field(encoded_subject_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_subject, V) -> V;
encode_typed_field(encoded_headline_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_headline, V) -> V;
encode_typed_field(encoded_alloc_text_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_alloc_text, V) -> V;
encode_typed_field(encoded_underlying_issuer_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_underlying_issuer, V) -> V;
encode_typed_field(encoded_underlying_security_desc_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_underlying_security_desc, V) -> V;
encode_typed_field(alloc_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(quote_set_valid_until_time, V) -> V;
encode_typed_field(quote_entry_reject_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(last_msg_seq_num_processed, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(on_behalf_of_sending_time, V) -> V;
encode_typed_field(ref_tag_id, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(ref_msg_type, V) -> V;
encode_typed_field(session_reject_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(bid_request_trans_type, V) -> V;
encode_typed_field(contra_broker, V) -> V;
encode_typed_field(compliance_id, V) -> V;
encode_typed_field(solicited_flag, true) -> <<"Y">>;
encode_typed_field(solicited_flag,false) -> <<"N">>;
encode_typed_field(exec_restatement_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(business_reject_ref_id, V) -> V;
encode_typed_field(business_reject_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(gross_trade_amt, V) -> V;
encode_typed_field(no_contra_brokers, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(max_message_size, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_msg_types, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(msg_direction, V) -> V;
encode_typed_field(no_trading_sessions, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(total_volume_traded, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(discretion_inst, V) -> V;
encode_typed_field(discretion_offset_value, V) -> V;
encode_typed_field(bid_id, V) -> V;
encode_typed_field(client_bid_id, V) -> V;
encode_typed_field(list_name, V) -> V;
encode_typed_field(tot_no_related_sym, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(bid_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(num_tickets, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(side_value1, V) -> V;
encode_typed_field(side_value2, V) -> V;
encode_typed_field(no_bid_descriptors, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(bid_descriptor_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(bid_descriptor, V) -> V;
encode_typed_field(side_value_ind, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(liquidity_pct_low, V) -> V;
encode_typed_field(liquidity_pct_high, V) -> V;
encode_typed_field(liquidity_value, V) -> V;
encode_typed_field(efp_tracking_error, V) -> V;
encode_typed_field(fair_value, V) -> V;
encode_typed_field(outside_index_pct, V) -> V;
encode_typed_field(value_of_futures, V) -> V;
encode_typed_field(liquidity_ind_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(wt_average_liquidity, V) -> V;
encode_typed_field(exchange_for_physical, true) -> <<"Y">>;
encode_typed_field(exchange_for_physical,false) -> <<"N">>;
encode_typed_field(out_main_cntry_u_index, V) -> V;
encode_typed_field(cross_percent, V) -> V;
encode_typed_field(prog_rpt_reqs, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(prog_period_interval, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(inc_tax_ind, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(num_bidders, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(bid_trade_type, V) -> V;
encode_typed_field(basis_px_type, V) -> V;
encode_typed_field(no_bid_components, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(country, V) -> V;
encode_typed_field(tot_no_strikes, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(price_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(day_order_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(day_cum_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(day_avg_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(gt_booking_inst, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_strikes, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(list_status_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(net_gross_ind, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(list_order_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(expire_date, V) -> V;
encode_typed_field(list_exec_inst_type, V) -> V;
encode_typed_field(cxl_rej_response_to, V) -> V;
encode_typed_field(underlying_coupon_rate, V) -> V;
encode_typed_field(underlying_contract_multiplier, V) -> V;
encode_typed_field(contra_trade_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(contra_trade_time, V) -> V;
encode_typed_field(clearing_firm, V) -> V;
encode_typed_field(clearing_account, V) -> V;
encode_typed_field(liquidity_num_securities, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(multi_leg_reporting_type, V) -> V;
encode_typed_field(strike_time, V) -> V;
encode_typed_field(list_status_text, V) -> V;
encode_typed_field(encoded_list_status_text_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_list_status_text, V) -> V;
encode_typed_field(party_id_source, V) -> V;
encode_typed_field(party_id, V) -> V;
encode_typed_field(total_volume_traded_date, V) -> V;
encode_typed_field(total_volume_traded_time, V) -> V;
encode_typed_field(net_chg_prev_day, V) -> V;
encode_typed_field(party_role, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_party_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_security_alt_id, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(security_alt_id, V) -> V;
encode_typed_field(security_alt_id_source, V) -> V;
encode_typed_field(no_underlying_security_alt_id, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(underlying_security_alt_id, V) -> V;
encode_typed_field(underlying_security_alt_id_source, V) -> V;
encode_typed_field(product, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(cfi_code, V) -> V;
encode_typed_field(underlying_product, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(underlying_cfi_code, V) -> V;
encode_typed_field(test_message_indicator, true) -> <<"Y">>;
encode_typed_field(test_message_indicator,false) -> <<"N">>;
encode_typed_field(quantity_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(booking_ref_id, V) -> V;
encode_typed_field(individual_alloc_id, V) -> V;
encode_typed_field(rounding_direction, V) -> V;
encode_typed_field(rounding_modulus, V) -> V;
encode_typed_field(country_of_issue, V) -> V;
encode_typed_field(state_or_province_of_issue, V) -> V;
encode_typed_field(locale_of_issue, V) -> V;
encode_typed_field(no_regist_dtls, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(mailing_dtls, V) -> V;
encode_typed_field(investor_country_of_residence, V) -> V;
encode_typed_field(payment_ref, V) -> V;
encode_typed_field(distrib_payment_method, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(cash_distrib_curr, V) -> V;
encode_typed_field(comm_currency, V) -> V;
encode_typed_field(cancellation_rights, V) -> V;
encode_typed_field(money_laundering_status, V) -> V;
encode_typed_field(mailing_inst, V) -> V;
encode_typed_field(trans_bkd_time, V) -> V;
encode_typed_field(exec_price_type, V) -> V;
encode_typed_field(exec_price_adjustment, V) -> V;
encode_typed_field(date_of_birth, V) -> V;
encode_typed_field(trade_report_trans_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(card_holder_name, V) -> V;
encode_typed_field(card_number, V) -> V;
encode_typed_field(card_exp_date, V) -> V;
encode_typed_field(card_iss_num, V) -> V;
encode_typed_field(payment_method, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(regist_acct_type, V) -> V;
encode_typed_field(designation, V) -> V;
encode_typed_field(tax_advantage_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(regist_rej_reason_text, V) -> V;
encode_typed_field(fund_renew_waiv, V) -> V;
encode_typed_field(cash_distrib_agent_name, V) -> V;
encode_typed_field(cash_distrib_agent_code, V) -> V;
encode_typed_field(cash_distrib_agent_acct_number, V) -> V;
encode_typed_field(cash_distrib_pay_ref, V) -> V;
encode_typed_field(cash_distrib_agent_acct_name, V) -> V;
encode_typed_field(card_start_date, V) -> V;
encode_typed_field(payment_date, V) -> V;
encode_typed_field(payment_remitter_id, V) -> V;
encode_typed_field(regist_status, V) -> V;
encode_typed_field(regist_rej_reason_code, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(regist_ref_id, V) -> V;
encode_typed_field(regist_dtls, V) -> V;
encode_typed_field(no_distrib_insts, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(regist_email, V) -> V;
encode_typed_field(distrib_percentage, V) -> V;
encode_typed_field(regist_id, V) -> V;
encode_typed_field(regist_trans_type, V) -> V;
encode_typed_field(exec_valuation_point, V) -> V;
encode_typed_field(order_percent, V) -> V;
encode_typed_field(ownership_type, V) -> V;
encode_typed_field(no_cont_amts, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(cont_amt_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(cont_amt_value, V) -> V;
encode_typed_field(cont_amt_curr, V) -> V;
encode_typed_field(owner_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(party_sub_id, V) -> V;
encode_typed_field(nested_party_id, V) -> V;
encode_typed_field(nested_party_id_source, V) -> V;
encode_typed_field(secondary_cl_ord_id, V) -> V;
encode_typed_field(secondary_exec_id, V) -> V;
encode_typed_field(order_capacity, V) -> V;
encode_typed_field(order_restrictions, V) -> V;
encode_typed_field(mass_cancel_request_type, V) -> V;
encode_typed_field(mass_cancel_response, V) -> V;
encode_typed_field(mass_cancel_reject_reason, V) -> V;
encode_typed_field(total_affected_orders, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_affected_orders, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(affected_order_id, V) -> V;
encode_typed_field(affected_secondary_order_id, V) -> V;
encode_typed_field(quote_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(nested_party_role, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_nested_party_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(total_accrued_interest_amt, V) -> V;
encode_typed_field(maturity_date, V) -> V;
encode_typed_field(underlying_maturity_date, V) -> V;
encode_typed_field(instr_registry, V) -> V;
encode_typed_field(cash_margin, V) -> V;
encode_typed_field(nested_party_sub_id, V) -> V;
encode_typed_field(scope, V) -> V;
encode_typed_field(md_implicit_delete, true) -> <<"Y">>;
encode_typed_field(md_implicit_delete,false) -> <<"N">>;
encode_typed_field(cross_id, V) -> V;
encode_typed_field(cross_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(cross_prioritization, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(orig_cross_id, V) -> V;
encode_typed_field(no_sides, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(username, V) -> V;
encode_typed_field(password, V) -> V;
encode_typed_field(no_legs, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_currency, V) -> V;
encode_typed_field(tot_no_security_types, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_security_types, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(security_list_request_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(security_request_result, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(round_lot, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(min_trade_vol, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(multi_leg_rpt_type_req, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_position_effect, V) -> V;
encode_typed_field(leg_covered_or_uncovered, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(trad_ses_status_rej_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trade_request_id, V) -> V;
encode_typed_field(trade_request_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(previously_reported, true) -> <<"Y">>;
encode_typed_field(previously_reported,false) -> <<"N">>;
encode_typed_field(trade_report_id, V) -> V;
encode_typed_field(trade_report_ref_id, V) -> V;
encode_typed_field(match_status, V) -> V;
encode_typed_field(match_type, V) -> V;
encode_typed_field(odd_lot, true) -> <<"Y">>;
encode_typed_field(odd_lot,false) -> <<"N">>;
encode_typed_field(no_clearing_instructions, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(clearing_instruction, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trade_input_source, V) -> V;
encode_typed_field(trade_input_device, V) -> V;
encode_typed_field(no_dates, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(account_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(cust_order_capacity, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(cl_ord_link_id, V) -> V;
encode_typed_field(mass_status_req_id, V) -> V;
encode_typed_field(mass_status_req_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(orig_ord_mod_time, V) -> V;
encode_typed_field(leg_settl_type, V) -> V;
encode_typed_field(leg_settl_date, V) -> V;
encode_typed_field(day_booking_inst, V) -> V;
encode_typed_field(booking_unit, V) -> V;
encode_typed_field(prealloc_method, V) -> V;
encode_typed_field(underlying_country_of_issue, V) -> V;
encode_typed_field(underlying_state_or_province_of_issue, V) -> V;
encode_typed_field(underlying_locale_of_issue, V) -> V;
encode_typed_field(underlying_instr_registry, V) -> V;
encode_typed_field(leg_country_of_issue, V) -> V;
encode_typed_field(leg_state_or_province_of_issue, V) -> V;
encode_typed_field(leg_locale_of_issue, V) -> V;
encode_typed_field(leg_instr_registry, V) -> V;
encode_typed_field(leg_symbol, V) -> V;
encode_typed_field(leg_symbol_sfx, V) -> V;
encode_typed_field(leg_security_id, V) -> V;
encode_typed_field(leg_security_id_source, V) -> V;
encode_typed_field(no_leg_security_alt_id, V) -> V;
encode_typed_field(leg_security_alt_id, V) -> V;
encode_typed_field(leg_security_alt_id_source, V) -> V;
encode_typed_field(leg_product, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_cfi_code, V) -> V;
encode_typed_field(leg_security_type, V) -> V;
encode_typed_field(leg_maturity_month_year, V) -> V;
encode_typed_field(leg_maturity_date, V) -> V;
encode_typed_field(leg_strike_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(leg_opt_attribute, V) -> V;
encode_typed_field(leg_contract_multiplier, V) -> V;
encode_typed_field(leg_coupon_rate, V) -> V;
encode_typed_field(leg_security_exchange, V) -> V;
encode_typed_field(leg_issuer, V) -> V;
encode_typed_field(encoded_leg_issuer_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_leg_issuer, V) -> V;
encode_typed_field(leg_security_desc, V) -> V;
encode_typed_field(encoded_leg_security_desc_len, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(encoded_leg_security_desc, V) -> V;
encode_typed_field(leg_ratio_qty, V) -> V;
encode_typed_field(leg_side, V) -> V;
encode_typed_field(trading_session_sub_id, V) -> V;
encode_typed_field(alloc_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_hops, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(hop_comp_id, V) -> V;
encode_typed_field(hop_sending_time, V) -> V;
encode_typed_field(hop_ref_id, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(mid_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(bid_yield, V) -> V;
encode_typed_field(mid_yield, V) -> V;
encode_typed_field(offer_yield, V) -> V;
encode_typed_field(clearing_fee_indicator, V) -> V;
encode_typed_field(working_indicator, true) -> <<"Y">>;
encode_typed_field(working_indicator,false) -> <<"N">>;
encode_typed_field(leg_last_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(priority_indicator, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(price_improvement, V) -> V;
encode_typed_field(price2, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(last_forward_points2, V) -> V;
encode_typed_field(bid_forward_points2, V) -> V;
encode_typed_field(offer_forward_points2, V) -> V;
encode_typed_field(rfq_req_id, V) -> V;
encode_typed_field(mkt_bid_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(mkt_offer_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(min_bid_size, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(min_offer_size, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(quote_status_req_id, V) -> V;
encode_typed_field(legal_confirm, true) -> <<"Y">>;
encode_typed_field(legal_confirm,false) -> <<"N">>;
encode_typed_field(underlying_last_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(underlying_last_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(sec_def_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_ref_id, V) -> V;
encode_typed_field(contra_leg_ref_id, V) -> V;
encode_typed_field(settl_curr_bid_fx_rate, V) -> V;
encode_typed_field(settl_curr_offer_fx_rate, V) -> V;
encode_typed_field(quote_request_reject_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(side_compliance_id, V) -> V;
encode_typed_field(acct_id_source, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(alloc_acct_id_source, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(benchmark_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(benchmark_price_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(confirm_id, V) -> V;
encode_typed_field(confirm_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(confirm_trans_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(contract_settl_month, V) -> V;
encode_typed_field(delivery_form, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(last_par_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(no_leg_allocs, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_alloc_account, V) -> V;
encode_typed_field(leg_individual_alloc_id, V) -> V;
encode_typed_field(leg_alloc_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_alloc_acct_id_source, V) -> V;
encode_typed_field(leg_settl_currency, V) -> V;
encode_typed_field(leg_benchmark_curve_currency, V) -> V;
encode_typed_field(leg_benchmark_curve_name, V) -> V;
encode_typed_field(leg_benchmark_curve_point, V) -> V;
encode_typed_field(leg_benchmark_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(leg_benchmark_price_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_bid_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(leg_ioi_qty, V) -> V;
encode_typed_field(no_leg_stipulations, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_offer_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(leg_order_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_price_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_stipulation_type, V) -> V;
encode_typed_field(leg_stipulation_value, V) -> V;
encode_typed_field(leg_swap_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(pool, V) -> V;
encode_typed_field(quote_price_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(quote_resp_id, V) -> V;
encode_typed_field(quote_resp_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(quote_qualifier, V) -> V;
encode_typed_field(yield_redemption_date, V) -> V;
encode_typed_field(yield_redemption_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(yield_redemption_price_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(benchmark_security_id, V) -> V;
encode_typed_field(reversal_indicator, true) -> <<"Y">>;
encode_typed_field(reversal_indicator,false) -> <<"N">>;
encode_typed_field(yield_calc_date, V) -> V;
encode_typed_field(no_positions, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(pos_type, V) -> V;
encode_typed_field(long_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(short_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(pos_qty_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(pos_amt_type, V) -> V;
encode_typed_field(pos_amt, V) -> V;
encode_typed_field(pos_trans_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(pos_req_id, V) -> V;
encode_typed_field(no_underlyings, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(pos_maint_action, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(orig_pos_req_ref_id, V) -> V;
encode_typed_field(pos_maint_rpt_ref_id, V) -> V;
encode_typed_field(clearing_business_date, V) -> V;
encode_typed_field(settl_sess_id, V) -> V;
encode_typed_field(settl_sess_sub_id, V) -> V;
encode_typed_field(adjustment_type, V) -> list_to_binary(integer_to_list(V));
...
encode_typed_field(pos_maint_rpt_id, V) -> V;
encode_typed_field(pos_maint_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(pos_maint_result, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(pos_req_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(response_transport_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(response_destination, V) -> V;
encode_typed_field(total_num_pos_reports, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(pos_req_result, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(pos_req_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(settl_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(settl_price_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(underlying_settl_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(underlying_settl_price_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(prior_settl_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(no_quote_qualifiers, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(alloc_settl_currency, V) -> V;
encode_typed_field(alloc_settl_curr_amt, V) -> V;
encode_typed_field(interest_at_maturity, V) -> V;
encode_typed_field(leg_dated_date, V) -> V;
encode_typed_field(leg_pool, V) -> V;
encode_typed_field(alloc_interest_at_maturity, V) -> V;
encode_typed_field(alloc_accrued_interest_amt, V) -> V;
encode_typed_field(delivery_date, V) -> V;
encode_typed_field(assignment_method, V) -> V;
encode_typed_field(assignment_unit, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(open_interest, V) -> V;
encode_typed_field(exercise_method, V) -> V;
encode_typed_field(tot_num_trade_reports, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trade_request_result, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trade_request_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trade_report_reject_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(side_multi_leg_reporting_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_pos_amt, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(auto_accept_indicator, true) -> <<"Y">>;
encode_typed_field(auto_accept_indicator,false) -> <<"N">>;
encode_typed_field(alloc_report_id, V) -> V;
encode_typed_field(no_nested2_party_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(nested2_party_id, V) -> V;
encode_typed_field(nested2_party_id_source, V) -> V;
encode_typed_field(nested2_party_role, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(nested2_party_sub_id, V) -> V;
encode_typed_field(benchmark_security_id_source, V) -> V;
encode_typed_field(security_sub_type, V) -> V;
encode_typed_field(underlying_security_sub_type, V) -> V;
encode_typed_field(leg_security_sub_type, V) -> V;
encode_typed_field(allowable_one_sidedness_pct, V) -> V;
encode_typed_field(allowable_one_sidedness_value, V) -> V;
encode_typed_field(allowable_one_sidedness_curr, V) -> V;
encode_typed_field(no_trd_reg_timestamps, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trd_reg_timestamp, V) -> V;
encode_typed_field(trd_reg_timestamp_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trd_reg_timestamp_origin, V) -> V;
encode_typed_field(confirm_ref_id, V) -> V;
encode_typed_field(confirm_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(confirm_rej_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(booking_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(individual_alloc_rej_code, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(settl_inst_msg_id, V) -> V;
encode_typed_field(no_settl_inst, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(last_update_time, V) -> V;
encode_typed_field(alloc_settl_inst_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_settl_party_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(settl_party_id, V) -> V;
encode_typed_field(settl_party_id_source, V) -> V;
encode_typed_field(settl_party_role, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(settl_party_sub_id, V) -> V;
encode_typed_field(settl_party_sub_id_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(dlvy_inst_type, V) -> V;
encode_typed_field(termination_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(next_expected_msg_seq_num, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(ord_status_req_id, V) -> V;
encode_typed_field(settl_inst_req_id, V) -> V;
encode_typed_field(settl_inst_req_rej_code, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(secondary_alloc_id, V) -> V;
encode_typed_field(alloc_report_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(alloc_report_ref_id, V) -> V;
encode_typed_field(alloc_canc_replace_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(copy_msg_indicator, true) -> <<"Y">>;
encode_typed_field(copy_msg_indicator,false) -> <<"N">>;
encode_typed_field(alloc_account_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(order_avg_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(order_booking_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_settl_party_sub_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_party_sub_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(party_sub_id_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_nested_party_sub_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(nested_party_sub_id_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_nested2_party_sub_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(nested2_party_sub_id_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(alloc_intermed_req_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(underlying_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(price_delta, V) -> V;
encode_typed_field(appl_queue_max, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(appl_queue_depth, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(appl_queue_resolution, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(appl_queue_action, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_alt_md_source, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(alt_md_source_id, V) -> V;
encode_typed_field(secondary_trade_report_id, V) -> V;
encode_typed_field(avg_px_indicator, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trade_link_id, V) -> V;
encode_typed_field(order_input_device, V) -> V;
encode_typed_field(underlying_trading_session_id, V) -> V;
encode_typed_field(underlying_trading_session_sub_id, V) -> V;
encode_typed_field(trade_leg_ref_id, V) -> V;
encode_typed_field(exchange_rule, V) -> V;
encode_typed_field(trade_alloc_indicator, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(expiration_cycle, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trd_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trd_sub_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(transfer_reason, V) -> V;
encode_typed_field(asgn_req_id, V) -> V;
encode_typed_field(tot_num_assignment_reports, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(asgn_rpt_id, V) -> V;
encode_typed_field(threshold_amount, V) -> V;
encode_typed_field(peg_move_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(peg_offset_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(peg_limit_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(peg_round_direction, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(pegged_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(peg_scope, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(discretion_move_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(discretion_offset_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(discretion_limit_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(discretion_round_direction, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(discretion_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(discretion_scope, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(target_strategy, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(target_strategy_parameters, V) -> V;
encode_typed_field(participation_rate, V) -> V;
encode_typed_field(target_strategy_performance, V) -> V;
encode_typed_field(last_liquidity_ind, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(publish_trd_indicator, true) -> <<"Y">>;
encode_typed_field(publish_trd_indicator,false) -> <<"N">>;
encode_typed_field(short_sale_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(qty_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(secondary_trd_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trade_report_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(alloc_no_orders_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(shared_commission, V) -> V;
encode_typed_field(confirm_req_id, V) -> V;
encode_typed_field(avg_par_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(reported_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(no_capacities, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(order_capacity_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_events, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(event_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(event_date, V) -> V;
encode_typed_field(event_px, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(event_text, V) -> V;
encode_typed_field(pct_at_risk, V) -> V;
encode_typed_field(no_instr_attrib, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(instr_attrib_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(instr_attrib_value, V) -> V;
encode_typed_field(dated_date, V) -> V;
encode_typed_field(interest_accrual_date, V) -> V;
encode_typed_field(cp_program, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(cp_reg_type, V) -> V;
encode_typed_field(underlying_cp_program, V) -> V;
encode_typed_field(underlying_cp_reg_type, V) -> V;
encode_typed_field(underlying_qty, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trd_match_id, V) -> V;
encode_typed_field(secondary_trade_report_ref_id, V) -> V;
encode_typed_field(underlying_dirty_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(underlying_end_price, V) -> iolist_to_binary(io_lib:format("~.3f", [V*1.0]));
encode_typed_field(underlying_start_value, V) -> V;
encode_typed_field(underlying_current_value, V) -> V;
encode_typed_field(underlying_end_value, V) -> V;
encode_typed_field(no_underlying_stips, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(underlying_stip_type, V) -> V;
encode_typed_field(underlying_stip_value, V) -> V;
encode_typed_field(maturity_net_money, V) -> V;
encode_typed_field(misc_fee_basis, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(tot_no_allocs, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(last_fragment, true) -> <<"Y">>;
encode_typed_field(last_fragment,false) -> <<"N">>;
encode_typed_field(coll_req_id, V) -> V;
encode_typed_field(coll_asgn_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(coll_inquiry_qualifier, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_trades, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(margin_ratio, V) -> V;
encode_typed_field(margin_excess, V) -> V;
encode_typed_field(total_net_value, V) -> V;
encode_typed_field(cash_outstanding, V) -> V;
encode_typed_field(coll_asgn_id, V) -> V;
encode_typed_field(coll_asgn_trans_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(coll_resp_id, V) -> V;
encode_typed_field(coll_asgn_resp_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(coll_asgn_reject_reason, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(coll_asgn_ref_id, V) -> V;
encode_typed_field(coll_rpt_id, V) -> V;
encode_typed_field(coll_inquiry_id, V) -> V;
encode_typed_field(coll_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(tot_num_reports, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(last_rpt_requested, true) -> <<"Y">>;
encode_typed_field(last_rpt_requested,false) -> <<"N">>;
encode_typed_field(agreement_desc, V) -> V;
encode_typed_field(agreement_id, V) -> V;
encode_typed_field(agreement_date, V) -> V;
encode_typed_field(start_date, V) -> V;
encode_typed_field(end_date, V) -> V;
encode_typed_field(agreement_currency, V) -> V;
encode_typed_field(delivery_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(end_accrued_interest_amt, V) -> V;
encode_typed_field(start_cash, V) -> V;
encode_typed_field(end_cash, V) -> V;
encode_typed_field(user_request_id, V) -> V;
encode_typed_field(user_request_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(new_password, V) -> V;
encode_typed_field(user_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(user_status_text, V) -> V;
encode_typed_field(status_value, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(status_text, V) -> V;
encode_typed_field(ref_comp_id, V) -> V;
encode_typed_field(ref_sub_id, V) -> V;
encode_typed_field(network_response_id, V) -> V;
encode_typed_field(network_request_id, V) -> V;
encode_typed_field(last_network_response_id, V) -> V;
encode_typed_field(network_request_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_comp_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(network_status_response_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_coll_inquiry_qualifier, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(trd_rpt_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(affirm_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(underlying_strike_currency, V) -> V;
encode_typed_field(leg_strike_currency, V) -> V;
encode_typed_field(time_bracket, V) -> V;
encode_typed_field(coll_action, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(coll_inquiry_status, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(coll_inquiry_result, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(strike_currency, V) -> V;
encode_typed_field(no_nested3_party_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(nested3_party_id, V) -> V;
encode_typed_field(nested3_party_id_source, V) -> V;
encode_typed_field(nested3_party_role, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(no_nested3_party_sub_ids, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(nested3_party_sub_id, V) -> V;
encode_typed_field(nested3_party_sub_id_type, V) -> list_to_binary(integer_to_list(V));
encode_typed_field(leg_contract_settl_month, V) -> V;
encode_typed_field(leg_interest_accrual_date, V) -> V;
